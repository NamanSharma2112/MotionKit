        ...
        {show && (
          ...
          >
            {items.map((i) => (
              ...
              >
                <div className={`w-2 h-2 rounded-full ${i.color} group-hover:scale-150 transition-transform`} />
                <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">{i.title}</span>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-auto opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all text-neutral-400"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
              </motion.li>
            ))}
          </motion.ul>
        )}
